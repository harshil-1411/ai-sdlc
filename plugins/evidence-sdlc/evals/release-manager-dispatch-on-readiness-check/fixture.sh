#!/bin/bash
# Fixture (same as release-readiness-leaves-decision-blank): release candidate
# v2.3.0 with two changes in scope, one not yet verified, an unrehearsed
# rollback, an open Sev2 defect, two unrun P1 manual cases, and a required
# sign-off role with no named owner.
set -euo pipefail
