...
description: Convert existing controlled documents — SOPs, validation protocols, requirement specifications, design documents, audit reports — from Word, PDF, spreadsheets or slides into markdown the artifact chain can read, keeping their identity as controlled records. Use at adoption and on statements like "we have existing SOPs in Word or PDF", "convert this document", "we already have a requirements spec". Never just retype a controlled document.
---
